...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleEasyCheckout(Request $request)
    {
        ...
        //$customer_address = $request->customer_address;
        return view('exampleEasycheckout', compact('customer_name', 'customer_email','customer_phone','customer_address'));
    }
            ...
            if ($validation == TRUE) {
                ...
                */
                $update_product = DB::table('orders')
                    ...
                    {   
                        $cartorder= new OrderedItem();
                  
                        $cartorder->customer_id=Auth::guard('customer')->user()->id;
                        
                        $cartorder->order_id= $order_detials->id;
