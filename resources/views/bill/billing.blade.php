      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          <!-- Custom tabs (Charts with tabs)-->
              ...
              <div class="card" style="width:100%;padding:20px; margin-top:5px">
                ...
                <form action="{{route ('bill')}}" method="post">
                  ...
                  <label for="subtotal">Total:  {{ Cart::getsubtotal() }} tk</label>
                  <!-- <textarea name="rphone" id="rphone" type="number" class="form-control" placeholder="Enter receiver phone number">{{ Cart::getsubtotal() }} </textarea> -->
                  <br>




                  <button type="submit" class="btn btn" style="background-color:#301934;color:white">I Confirm My Order</button>
                </form>
