  ...
  <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="assets/img/slider/slider4.jpg" alt="" title="#slider-direction-1" />
        <img src="assets/img/slider/slider5.jpg" alt="" title="#slider-direction-2" />
        <img src="assets/img/slider/slider6.jpg" alt="" title="#slider-direction-3" />
      </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content text-center">
                ...
                <div class="layer-1-2 wow animate__fadeIn animate__animated" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Get Hygienic Foods </h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow animate__slideInUp animate__animated" data-wow-duration="2s" data-wow-delay=".2s">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="slider-content">
                ...
                <!-- layer 2 -->
                <div class="layer-1-2 wow animate__fadeIn animate__animated" data-wow-duration="2s" data-wow-delay=".1s">
                  <h1 class="title2">Get Traditional Test In Your Event</h1>
                </div>
                <!-- layer 3 -->
                <div class="layer-1-3 hidden-xs wow animate__slideInUp animate__animated" data-wow-duration="2s" data-wow-delay=".2s">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              ...
              <div class="team-content text-center">
              <h4>Nannu Catering service</h4>
                <p>Adress-Dhaka</p>
                <p>Service Location-Whole Bangladesh</p>
                <p>Contact-01254785644</p>
              </div>
            </div>
          </div>
          <!-- End column -->
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              ...
              <div class="team-content text-center">
              <h4>Dhaka Food</h4>
                <p>Adress-Badda, Dhaka</p>
                <p>Service Location-Whole Bangladesh</p>
                <p>Contact-01564782411</p>
              </div>
            </div>
          </div>
          <!-- End column -->
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              ...
              <div class="team-content text-center">
              <h4>Bengali Catering</h4>
                <p>Adress-Badda, Dhaka</p>
                <p>Service Location-Dhaka,Chittagong</p>
                <p>Contact-01854142423</p>
              </div>
            </div>
          </div>
          <!-- End column -->
