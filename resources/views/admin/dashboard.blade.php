  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="margin-top:90px">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="{{ asset (Auth::guard('admin')->user()->image) }}" class="img-circle elevation-2" alt="Avatar" class=".avatar">
        </div>
        <div class="info">
...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
            <div class="card text-white bg-dark mb-1" style="max-width: 82rem;">
  ...
  <tr>
    <td>{{ ++$i }}</td>
    <td>{{ $user->username }}</td>
    <td><img src="{{ asset($user->image)}}" alt="user image" img style="border:2px double black;" height=50 width=50></img></td>
    <td>{{ $user->email }}</td>
