...
<div>
        <div class="mx-auto pull-right">
            <div class="">
                <form action="{{ route('admin.customer.index') }}" method="GET" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <a href="{{ route('admin.customer.index') }}" class=" mt-1">
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-left">
                <a class="btn btn-success" href="{{ route('admin.customer.create') }}"> Create New Customer</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><img src="{{ asset($customer->image)}}" alt="user image" img style="border:1px double black;" height=50 width=50></img></td>
