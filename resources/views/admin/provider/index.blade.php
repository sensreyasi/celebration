...
<div>
        <div class="mx-auto pull-right">
            <div class="">
                <form action="{{ route('admin.provider.index') }}" method="GET" role="search">

                    <div class="input-group">
                        <span class="input-group-btn mr-5 mt-1">
                            <button class="btn btn-info" type="submit" title="Search providers">
                                <span class="fas fa-search"></span>
                            </button>
                        </span>
                        <input type="text" class="form-control mr-2" name="term" placeholder="Search providers" id="term">
                        <a href="{{ route('admin.provider.index') }}" class=" mt-1">
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-left">
                <a class="btn btn-success" href="{{ route('admin.provider.create') }}"> Create New Provider</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><img src="{{ asset($provider->image)}}" alt="user image" img style="border:1px double black;" height=50 width=50></img></td>
            <td>{{ $provider->email }}</td>
            <td>
                <form action="{{ route('admin.provider.destroy',$provider->id) }}" method="POST">
   
                    <a class="btn btn-info" href="{{ route('admin.provider.show',$provider->id) }}">Show</a>
    
                    <a class="btn btn-primary" href="{{ route('admin.provider.edit',$provider->id) }}">Edit</a>
