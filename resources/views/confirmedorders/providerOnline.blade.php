        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card-header" style="text-align:center;color:white;background-color:#301934"><strong>Product Orders (Online Payment)</strong></div>
              
              <div class="card-body">
            <a href="/confirmedorders" class="btn btn " style="background-color:#301934;color:white;margin-top:-10px;margin-bottom:10px;margin-left:-8px" role="button" aria-pressed="true">Show COD Payments</a>
