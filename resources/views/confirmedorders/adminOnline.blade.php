      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="card" style="width:100%;margin-top:100px; padding-bottom:100px">
            ...
            <div class="card-body">
              <a href="/allCODconfirmedorders" class="btn btn " style="background-color:#301934;color:white;margin-bottom:10px" role="button" aria-pressed="true">Show COD Payments</a
