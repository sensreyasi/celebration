        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card-body">
            <a href="/myconfirmedorders" class="btn btn " style="background-color:#301934;color:white;margin-bottom:10px;margin-left:-8px" role="button" aria-pressed="true">Show COD Payments</a>
