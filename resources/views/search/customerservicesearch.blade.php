            ...
            <div class="col-sm-6 col-md-4">
              <div class="card border-white">
                ...
                <div class="card-body">
                  ...
                  <p style="text-align:center"><a style="color:indigo"   href="service/{{$service->id}}/review">Reviews</a>
                  <a href="{{ route('customer.addservice', $service->id) }}" class="btn btn-secondary" style="background-color:#301949">Add </a>
                  </p>
                </div>
              </div>
            </div>
