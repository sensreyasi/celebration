        ...
        <div class="boxz" style="border:1px white solid;margin:30px; margin-top:63px; margin-bottom:100px;padding:50px" </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-4" style="padding:20px">
              ...
              <div class="card border-white" style="margin-top:-8px;">
                ...
                <div class="card-body" style="padding:0.25rem">
                  ...
                  <p class="card-text" style="text-align:center;margin-bottom:5px;margin-top:10px">Provider: {{ $product->provider->username }}</p>
                  <p class="card-text" style="text-align:center">{{ $product->description }}</p>
                  <p class="card-text" style="text-align:center;margin-bottom:2px">{{ $product->price }} BDT</p>
                  <p style="text-align:center"><a href="product/{{$product->id}}/providerreview" style="color:indigo;margin-bottom:-50px">Reviews</a>
                 
                  <!-- <p style="text-align:center"><a href="product/{{$product->id}}/review">Reviews</a> -->
                  </p>
                </div>
              </div>
            </div>
            ...
            {{$products->links()}}
            @else
            <h5 style="text-align:center;margin:100px;padding-bottom:160px">No such products</h5>
          </div>
        </div>
        @endif
